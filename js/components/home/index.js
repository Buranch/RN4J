				...
				<Content showsVerticalScrollIndicator={false}>
					...
					<Card style={{ backgroundColor: "#fff", marginTop: 0, marginRight: 0 }}>
						...
						>
							<View style={styles.newsContent}>
								<Text numberOfLines={2} style={styles.newsHeader}>
									It is easier with Flat App design to quickly convey information while still looking
						...
						>
							<View style={styles.newsContent}>
								<Text numberOfLines={2} style={styles.newsHeader}>
									NativeBase builds a layer on top of React Native that provides, basic set of

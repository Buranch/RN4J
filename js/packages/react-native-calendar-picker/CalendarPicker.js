...
var { StyleSheet, View, Text, TouchableOpacity } = require("react-native");

var { WEEKDAYS, MONTHS, MAX_ROWS, MAX_COLUMNS, getDaysInMonth } = require("./Util");
...
var Day = createReactClass({
	...
	render() {
		if (this.props.selected) {
			...
			return (
				<View style={styles.dayWrapper}>
					<TouchableOpacity style={styles.dayButton} onPress={() => this.props.onDayChange(this.props.day)}>

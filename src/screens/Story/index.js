...
import { Image, TouchableOpacity, Platform, Slider, Dimensions, View as RNView } from "react-native";
		...
		return (
			<Container style={{ backgroundColor: "#fff" }}>
				<Image source={require("../../../assets/bg-transparent.png")} style={styles.container}>
					<Header
						style={[styles.headerStyle, this.state.open ? styles.headerModalStyle : styles.headerStyle]}
					>

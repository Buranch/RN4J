                ...
                <View style={{ padding: 20 }}>
                  <View style={styles.newsCommentContainer}>
                    <Text style={styles.newsComment}>
                      ...
                      focussed on efficiency. The flat design enables resizing
                      the contents easily to fit various screen devices. Eye
                      soothing color makes the React Native Flat app theme
                      simple yet eye catchy and smooth running.
                    </Text>
                  ...
                  <View style={{ paddingBottom: 20, paddingTop: 10 }}>
                    <Text style={styles.newsHeader}>
                      ...
                      application development. This helps you to build
